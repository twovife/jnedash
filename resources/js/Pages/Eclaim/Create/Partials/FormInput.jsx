...
export default function FormInput({
    ...
    return (
        <div className="bg-white dark:bg-gray-800 px-5">
            <form id="forms" onSubmit={onHandleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <TextInput
                            ...
                            type={"text"}
                            value={dayjs(response.date_input).format(
                                "DD-MM-YYYY"
                            )}
                            disabled
                        />
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            className="mt-1 block w-full"
                            type={"text"}
                            value={response.receiver_phone}
                            disabled
                        />
                    </div>
                    <div className="col-span-2">
                        <InputLabel value={"Kota Tujuan"} forInput={"dest"} />
                        <TextInput
                            id={"dest"}
                            className="mt-1 block w-full"
                            type={"text"}
                            value={response.receiver_dest}
                            disabled
                        />
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <SelectList
                            ...
                            className="mt-1 block w-full"
                            required
                            disabled={response.asuransi == "no" ? false : true}
                            onChange={onHandleChange}
                            options={[
                                {
                                    id: 1,
                ...
                <div className="my-4 font-semibold text-gray-600 dark:text-gray-400">
                    Pelapor
                    <hr />
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
